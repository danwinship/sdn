...
func (np *networkPolicyPlugin) parsePeerFlows(npns *npNamespace, npp *npPolicy, policy *networkingv1.NetworkPolicy, peers []networkingv1.NetworkPolicyPeer, dir flowDirection) []string {
	if len(peers) == 0 {
