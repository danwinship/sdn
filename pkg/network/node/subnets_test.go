...
func setupHostSubnetWatcher(t *testing.T, ipversion common.IPVersion) (*hostSubnetWatcher, []string) {
	_, oc, _ := setupOVSController(t, ipversion)
...
func TestHostSubnetWatcher(t *testing.T) {
	hsw, flows := setupHostSubnetWatcher(t, common.IPv4)
...
func TestHostSubnetWatcherIPv6(t *testing.T) {
	hsw, flows := setupHostSubnetWatcher(t, common.IPv6)
	...
	err = assertHostSubnetFlowChanges(hsw, &flows,
		flowChange{
			kind:  flowAdded,
			match: []string{"table=10", "tun_src=2600:5200::2"},
		},
		flowChange{
			kind:  flowAdded,
			match: []string{"table=50", "arp", "arp_tpa=fd01:0:0:1::/64", "2600:5200::2->tun_dst"},
		},
		flowChange{
			kind:  flowAdded,
			match: []string{"table=90", "ip", "nw_dst=fd01:0:0:1::/64", "2600:5200::2->tun_dst"},
		},
		flowChange{
			kind:    flowRemoved,
			match:   []string{"table=111", "goto_table:120"},
		...
		flowChange{
			kind:  flowAdded,
			match: []string{"table=111", "2600:5200::2->tun_dst"},
		},
	)
	if err != nil {
		t.Fatalf("%v", err)
	...
	err = assertHostSubnetFlowChanges(hsw, &flows,
		flowChange{
			kind:  flowAdded,
			match: []string{"table=10", "tun_src=2600:5200::3"},
		},
		flowChange{
			kind:  flowAdded,
			match: []string{"table=50", "arp", "arp_tpa=fd01:0:0:2::/64", "2600:5200::3->tun_dst"},
		},
		flowChange{
			kind:  flowAdded,
			match: []string{"table=90", "ip", "nw_dst=fd01:0:0:2::/64", "2600:5200::3->tun_dst"},
		},
		flowChange{
			kind:  flowRemoved,
			match: []string{"table=111", "2600:5200::2->tun_dst"},
		...
		flowChange{
			kind:  flowAdded,
			match: []string{"table=111", "2600:5200::2->tun_dst", "2600:5200::3->tun_dst"},
		},
	)
	if err != nil {
		t.Fatalf("%v", err)
	...
	err = assertHostSubnetFlowChanges(hsw, &flows,
		...
		flowChange{
			kind:    flowAdded,
			match:   []string{"table=111", "2600:5200::3->tun_dst"},
