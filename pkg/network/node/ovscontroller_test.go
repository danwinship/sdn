...
var expectedFlows = []string{
	...
	" cookie=0x0f46ee1a3cac3bd5, table=10, priority=100, tun_src=10.0.123.45, actions=goto_table:30",
	" cookie=0, table=10, priority=0, actions=drop",
	" cookie=0, table=20, priority=300, udp, udp_dst=4789, actions=drop",
	" cookie=0x04a7761d70ec6c41, table=20, priority=100, in_port=3, arp, arp_spa=10.128.0.2, arp_sha=00:00:0a:80:00:02/00:00:ff:ff:ff:ff, actions=load:42->NXM_NX_REG0[],goto_table:21",
	...
	" cookie=0x04a7761d70ec6c41, table=40, priority=100, arp, arp_tpa=10.128.0.2, actions=output:3",
	" cookie=0, table=40, priority=0, actions=drop",
	" cookie=0x0f46ee1a3cac3bd5, table=50, priority=100, arp, arp_tpa=10.128.2.0/23, actions=move:NXM_NX_REG0[]->NXM_NX_TUN_ID[0..31],set_field:10.0.123.45->tun_dst,output:1",
