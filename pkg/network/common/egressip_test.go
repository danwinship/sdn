...
func TestEgressIPv6(t *testing.T) {
	...
	updateNetNamespaceEgress(eit, &networkv1.NetNamespace{
		NetID:     42,
		EgressIPs: []string{"2600:5200::100"},
	})
	err = w.assertChanges(
		"namespace 42 dropped",
	)
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::3",
		EgressIPs: []string{"2600:5200::100"}, // Added :100
	})
	err = w.assertChanges(
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::3",
		EgressIPs: []string{"2600:5200::100", "2600:5200::101"}, // Added :101
	})
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::5",
		EgressIPs: []string{"2600:5200::105"},
	})
	err = w.assertNoChanges()
	if err != nil {
		t.Fatalf("%v", err)
	...
	updateNetNamespaceEgress(eit, &networkv1.NetNamespace{
		NetID:     43,
		EgressIPs: []string{"2600:5200::101"},
	})
	err = w.assertChanges(
	...
	updateNetNamespaceEgress(eit, &networkv1.NetNamespace{
		NetID:     44,
		EgressIPs: []string{"2600:5200::104"},
	})
	err = w.assertChanges(
		"namespace 44 dropped",
	)
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::4",
		EgressIPs: []string{"2600:5200::102", "2600:5200::104"}, // Added :102, :104
	})
	err = w.assertChanges(
	...
	updateNetNamespaceEgress(eit, &networkv1.NetNamespace{
		NetID:     44,
		EgressIPs: []string{"2600:5200::102"},
	})
	err = w.assertChanges(
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::4",
		EgressIPs: []string{"2600:5200::102", "2600:5200::103"}, // Added :103, Dropped :104
	})
	err = w.assertNoChanges()
	if err != nil {
		t.Fatalf("%v", err)
	...
	updateNetNamespaceEgress(eit, &networkv1.NetNamespace{
		NetID:     45,
		EgressIPs: []string{"2600:5200::103"},
	})
	err = w.assertChanges(
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::3",
		EgressIPs: []string{"2600:5200::100"}, // Dropped :101
	})
	err = w.assertChanges(
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::4",
		EgressIPs: []string{"2600:5200::102"}, // Dropped :103
	})
	err = w.assertChanges(
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::3",
		EgressIPs: []string{"2600:5200::100", "2600:5200::103"}, // Added :103
	})
	err = w.assertChanges(
	...
	updateHostSubnetEgress(eit, &networkv1.HostSubnet{
		HostIP:    "2600:5200::4",
		EgressIPs: []string{"2600:5200::101", "2600:5200::102"}, // Added :101
	})
	err = w.assertChanges(
